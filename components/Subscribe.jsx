...
const Subscribe = () => {
    ...
    return (
        <div className='min-h-full pb-32 relative px-5 lg:px-20  text-[#003e39] max-h-fit w-full bg-[#f6f8fe]'>
            <div className='flex w-full  h-full  flex-col '>
                <p className='w-full lg:w-[60%] mt-44  text-7xl font-extrabold'>
                    Explore and spread: Ruul Blog            </p>
                <p className='w-full lg:w-[40%] mt-10  text-xl pr-20'>
            ...
            flex-col lg:flex-row gap-10 mt-32'>
                <div className='bg-[#f6f8fe] w-full lg:w-1/3 h-full mx-0 lg:mx-36 flex flex-col justify-between py-5 px-6 rounded-2xl border border-[#003e39]'>
                ...
                <div className='w-full lg:w-fit p-1 lg:p-12 flex items-end'>

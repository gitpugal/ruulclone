...
const Solutions = () => {
    ...
    return (
        <div className='min-h-full pb-36 border-b-[1px] border-[#003e39] relative px-5 lg:px-20  text-[#003e39] max-h-fit w-full bg-[#feeeca]'>
            <div className='flex w-full  h-full  flex-col lg:flex-row '>
                <p className=' absolute left-22 top-24 '>
                    WORK SOLUTIONS FOR TODAY                </p>
                <p className='w-[60%] mt-36 lg:mt-44  text-7xl font-extrabold'>
                    Remedies for the new work landscape
                </p>
                <p className='w-full lg:w-[40%] m-10 lg:mt-44   text-xl pr-20'>
                    Discover our smart worktech solutions and products designed to future-proof your work, and meet today&apos;s needs with ease.
                </p>
            </div>
            <div className='flex text-[#003e39] [&>*:nth-child(2n)]:flex-row-reverse  flex-col gap-5 lg:gap-24 mt-32'>
                {cardData.map((data, index) => (
                    <div key={index} className='w-full px-0  lg:px-10  h-fit justify-center [&>*:nth-child(1n)]:bg-[#f6f8fe] [&>*:nth-child(2n)]:bg-[#86efac] flex  flex-reverse gap-0 lg:gap-10'>
                        <div className={`flex border-[1px] border-[#003e39] flex-col py-20 gap-5  items-center justify-evenly  px-10 w-full lg:w-1/2   h-3/4 rounded-2xl`}>
                        ...
                        <div className='py-24 hidden lg:block border-[1px] border-[#003e39]  px-10 w-1/2 min-h-full bg-green-300 max-h-full rounded-2xl'>

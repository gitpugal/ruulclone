...
const Work = () => {
  ...
  return (
    <div className='min-h-full pb-32 relative px-5 lg:px-20  text-[#cafdc6] max-h-fit w-full bg-[#003e39]'>
        <div className='flex w-full  h-full  flex-col lg:flex-row gap-7'>
            ...
            <p className='w-full lg:w-[40%] mt-44   text-xl pr-0 lg:pr-20'>
        ...
        <div className='flex text-[#003e39] flex-col lg:flex-row gap-10 mt-32'>
            {cardData.map((data, index) => (
                <div key={index} className={`flex mx-auto  flex-col items-center justify-evenly mx-14 px-10 w-full lg:w-1/2 ${data.bg}  h-screen rounded-2xl`}>
                    ...
                    <ul className='grid list-disc gap-5 grid-cols-1 lg:grid-cols-2'>
                    ...
                    <p className='hidden lg:block'>{data.talent}</p>
                </div>
            ))}
        </div>
    </div>

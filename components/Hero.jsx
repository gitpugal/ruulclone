...
const Hero = () => {
    ...
    return (
        <div className='w-screen relative border-b-[1px] border-[#003e39] px-5 md:px-24  text-left flex flex-col md:flex-row gap-10 items-center justify-center h-fit pt-20 pb-36  bg-[#c9fec6]'>
            ...
            <div className='h-full   w-1/2 hidden md:flex flex-col items-center justify-center'>
